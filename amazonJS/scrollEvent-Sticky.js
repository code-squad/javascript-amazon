...
class ScrollEvent_sticky {
  ...
  init() {
    const closeBtn = qs(".close-button", this.hiddenLayer);
    const closeArrowBtn = qs(".close-button-foot", this.hiddenLayer);
    const openArrowBtn = qs(".top-layer-trigger-button", this.stickyLayer);
