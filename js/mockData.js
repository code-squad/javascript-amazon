const mockData = [
  {
    title: "Moulin Rouge",
    image: "http://dummyimage.com/227x119.jpg/dddddd/000000",
    header: "1Analog Circuit Design manager",
    contents: [
      "Morbi vel lectus in quam fringilla rhoncus. ",
      "Sed accumsan felis. Ut at dolor quis odio consequat varius.",
      "Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, ",
      "Maecenas pulvinar lobortis est. Phasellus sit amet erat. ."
    ]
  },
  {
    title: "One Night with the King",
    image: "http://dummyimage.com/249x161.png/5fa2dd/ffffff",
    header: "2Clinical Specialist",
    contents: [
  ...
  {
    title: "Hanna",
    image: "http://dummyimage.com/109x136.bmp/dddddd/000000",
    header: "3Safety Technician I",
    contents: [
  ...
  {
    title: "Smile",
    image: "http://dummyimage.com/229x242.bmp/ff4444/ffffff",
    header: "4Executive Secretary",
    contents: [
